...
def main():
    ...
    parser.add_argument('--model_config', type=str, default='/root/autodl-tmp/StyleID/models/ldm/stable-diffusion-v1/v1-inference.yaml', help='model config')
    parser.add_argument('--precomputed', type=str, default='./precomputed_feats', help='save path for precomputed feature')
    parser.add_argument('--ckpt', type=str, default='/root/autodl-tmp/StyleID/models/ldm/stable-diffusion-v1/sd-v1-4.ckpt', help='model checkpoint')
